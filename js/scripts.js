...
/******/ 		return __webpack_require__.p + "" + ({"vendors~indigo-fullpage":"vendors~indigo-fullpage","indigo-fullpage":"indigo-fullpage","vendors~indigo-polyfills":"vendors~indigo-polyfills","indigo-polyfills":"indigo-polyfills","vendors~indigo-sidebarStick":"vendors~indigo-sidebarStick","indigo-sidebarStick":"indigo-sidebarStick"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
/* harmony import */ var _modules_publicPath__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/publicPath */ "./src/js/modules/publicPath.js");
/* harmony import */ var _modules_publicPath__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_publicPath__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _modules_pageOnScroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/pageOnScroll */ "./src/js/modules/pageOnScroll.js");
...
if (typeof DOMTokenList !== "function" || !window.requestAnimationFrame || !('CSS' in window && 'supports' in CSS && CSS.supports('color', 'var(--body-color)'))) {
  var promise = _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_2___default.a.resolve();

  Promise.all(/*! import() | indigo-polyfills */[__webpack_require__.e("vendors~indigo-polyfills"), __webpack_require__.e("indigo-polyfills")]).then(__webpack_require__.bind(null, /*! ./modules/polyfills */ "./src/js/modules/polyfills.js"));
}
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (fullPageElement && 'fullPageLicense' in window.indigo) {
    Promise.all(/*! import() | indigo-fullpage */[__webpack_require__.e("vendors~indigo-fullpage"), __webpack_require__.e("indigo-fullpage")]).then(__webpack_require__.bind(null, /*! ./modules/fullPageInit */ "./src/js/modules/fullPageInit.js"));
  }
});


document.addEventListener('DOMContentLoaded', function () {
  var stickSidebarElement = document.querySelector('.has-sticky-sidebar #secondary');

  if (stickSidebarElement) {
    Promise.all(/*! import() | indigo-sidebarStick */[__webpack_require__.e("vendors~indigo-sidebarStick"), __webpack_require__.e("indigo-sidebarStick")]).then(__webpack_require__.bind(null, /*! ./modules/sidebarStick */ "./src/js/modules/sidebarStick.js"));
  }
...
(function () {
  ...
  button.onclick = function () {
    ...
    if (-1 !== _babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_2___default()(_context2 = document.body.className).call(_context2, 'menu-toggled')) {
  ...
  function toggleFocus(e) {
    ...
    while (-1 === _babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_2___default()(_context3 = self.className).call(_context3, 'nav-menu')) {
      var _context3;
      ...
      if ('li' === self.tagName.toLowerCase()) {
        ...
        if (-1 !== _babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_2___default()(_context4 = self.className).call(_context4, 'focus')) {
  ...
  (function () {
    ...
    if ('ontouchstart' in window) {
      touchStartFn = function touchStartFn(e) {
        var menuItem = this.parentNode; // li.menu-item-has-children
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_every__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/instance/every */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/every.js");
...
if (!requestFrame) {
  ...
  _babel_runtime_corejs3_core_js_stable_instance_every__WEBPACK_IMPORTED_MODULE_3___default()(_context = ['ms', 'moz', 'webkit', 'o']).call(_context, function (prefix) {
...
function handleScroll() {
  ...
  if (scrollY !== scrollYCached) {
    ...
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_2___default()(_context2 = callbackQueue.y).call(_context2, triggerCallback.y);
  ...
  if (scrollX !== scrollXCached) {
    ...
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_2___default()(_context3 = callbackQueue.x).call(_context3, triggerCallback.x);
  ...
  if (isScrollChanged) {
    ...
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_2___default()(_context4 = callbackQueue.any).call(_context4, triggerCallback.any);
...
function onScrolling(direction, callback) {
  ...
  if (typeof callback === 'function') {
    if (~_babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_1___default()(directionX).call(directionX, direction)) {
      callbackQueue.x.push(callback);
    } else if (~_babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_1___default()(directionAll).call(directionAll, direction)) {
...
onScrolling.remove = function (direction, fn) {
  ...
  fnIdx = _babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_1___default()(queue).call(queue, fn);

  if (fnIdx > -1) {
    _babel_runtime_corejs3_core_js_stable_instance_splice__WEBPACK_IMPORTED_MODULE_0___default()(queue).call(queue, fnIdx, 1);
...
var pageOnScroll = /*#__PURE__*/function () {
  ...
  function pageOnScroll() {
    ...
    this.doHeader = function (fade, headerColor) {
      ...
      document.documentElement.style.setProperty('--header-text-color', _this.headerTextColor);
    };
    ...
    this.headerScrollBg = function () {
      if (_this.isHeaderScrollBg) {
        var headerBgElements = _this.headerBgElements,
            headerBgColor = _this.headerBgColor,
            rgb2rgba = _this.rgb2rgba,
            doHeader = _this.doHeader;
        ...
        var docEle = document.documentElement,
            ...
            fade = 0,
            headerColour = _this.headerTextColor;
        ...
        if (scrolled > 25 && scrolled < _threshold) {
          ...
          headerColour = _this.isHeaderScrollBg ? _this.baseTextColor : _this.headerTextColor;
        }
    ...
    this.bodyScrolled = function (windowScrolled) {
      ...
      if (_this.fixedBrandingWrapper) {
        header = _this.fixedBrandingWrapper.offsetHeight;
      }
    ...
    this.reCalculateHeader = function () {
      var self = _this;

      if (self.fixedBrandingWrapper) {
        window.requestAnimationFrame(function () {
          var newHeight = self.fixedBrandingWrapper.offsetHeight + 'px';
          document.documentElement.style.setProperty('--header-height', newHeight);
        });
      }
    };

    this.initialHeaderHeight = function () {
      var self = _this;
    ...
    var headerScrollBg = this.headerScrollBg,
        reCalculateHeader = this.reCalculateHeader,
        initialHeaderHeight = this.initialHeaderHeight,
    ...
    this.fixedHeader = document.querySelector('.has-fixed-header'); //this.fixedBrandingWrapper = document.querySelector('.has-fixed-header.indigo-calculate-header .site-header-wrapping');
    ...
    if (this.isHeaderScrollBg) {
      _docEle.style.setProperty('--header-text-color', this.headerTextColor);
    }

    bodyScrolled();
    headerScrollBg();
    Object(_onScrolling__WEBPACK_IMPORTED_MODULE_7__["default"])(function () {
      var windowScrolled = (window.pageYOffset || _docEle.scrollTop) - (_docEle.clientTop || 0);
    ...
    if (this.fixedBrandingWrapper || this.headerOverlaysContent) {
      ...
      window.addEventListener('resize', Object(lodash__WEBPACK_IMPORTED_MODULE_8__["debounce"])(reCalculateHeader, 10));
      window.addEventListener('resize', Object(lodash__WEBPACK_IMPORTED_MODULE_8__["debounce"])(initialHeaderHeight, 100));
      window.addEventListener('indigoCustomizerUpdate', reCalculateHeader);
      var transition = document.querySelector('.custom-logo-link');

      if (transition) {
        var self = this;
        transition.addEventListener(self.whichTransitionEvent(), function () {
