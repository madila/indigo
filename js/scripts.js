...
if (typeof DOMTokenList !== "function" || !window.requestAnimationFrame || !('CSS' in window && 'supports' in CSS && CSS.supports('color', 'var(--body-color)'))) {
  var promise = _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_5___default.a.resolve();
...
/* harmony import */ var _onScrolling__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./onScrolling */ "./src/js/modules/onScrolling.js");
...
var pageOnScroll = /*#__PURE__*/function () {
  function pageOnScroll() {
    ...
    _babel_runtime_corejs3_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, pageOnScroll);
    ...
    bodyScrolled();
    headerScrollBg();
    Object(_onScrolling__WEBPACK_IMPORTED_MODULE_6__["default"])(function () {
    ...
    if (this.fixedBrandingWrapper || this.headerOverlaysContent) {
      ...
      window.addEventListener('resize', Object(lodash__WEBPACK_IMPORTED_MODULE_7__["debounce"])(reCalculateHeader, 10));
      window.addEventListener('resize', Object(lodash__WEBPACK_IMPORTED_MODULE_7__["debounce"])(initialHeaderHeight, 100));
  ...
  _babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(pageOnScroll, [{
    key: "getCSSVar",
    value:
    /**
     * hexToRgb
    ...
    function getCSSVar(property) {
      ...
      return _babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_3___default()(_context4 = getComputedStyle(document.documentElement).getPropertyValue(property)).call(_context4);
    }
  }, {
    key: "getPosition",
