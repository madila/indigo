...
var pageOnScroll = /*#__PURE__*/function () {
  function pageOnScroll() {
    ...
    (0,_babel_runtime_corejs3_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, pageOnScroll);

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "hexToRgb", function (hex) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "rgb2rgba", function (r, g, b) {
      var _context, _context2, _context3;

      var alpha = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
      return _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_3___default()(_context = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_3___default()(_context2 = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_3___default()(_context3 = "rgba(".concat(r, ",")).call(_context3, g, ",")).call(_context2, b, ",")).call(_context, alpha, ")");
    });

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "doHeader", function (fade, headerColor) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "whichTransitionEvent", function () {
      var t;
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "headerScrollBg", function () {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "bodyScrolled", function (windowScrolled) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "reCalculateHeader", function () {
      var self = _this;
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "initialHeaderHeight", function () {
      var self = _this;
    ...
    bodyScrolled();
    headerScrollBg();
    (0,_onScrolling__WEBPACK_IMPORTED_MODULE_7__["default"])(function () {
    ...
    if (this.fixedBrandingWrapper || this.headerOverlaysContent) {
      ...
      window.addEventListener('resize', (0,lodash__WEBPACK_IMPORTED_MODULE_8__.debounce)(reCalculateHeader, 10));
      window.addEventListener('resize', (0,lodash__WEBPACK_IMPORTED_MODULE_8__.debounce)(initialHeaderHeight, 100));
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(pageOnScroll, [{
    key: "getCSSVar",
    value:
    /**
     * hexToRgb
    ...
    function getCSSVar(property) {
      ...
      return _babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_4___default()(_context4 = getComputedStyle(document.documentElement).getPropertyValue(property)).call(_context4);
    }
  }, {
    key: "getPosition",
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkindigo"] = self["webpackChunkindigo"] || [];
...
/* harmony import */ var _modules_publicPath__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/publicPath */ "./src/js/modules/publicPath.js");
/* harmony import */ var _modules_publicPath__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_publicPath__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _modules_navigation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/navigation */ "./src/js/modules/navigation.js");
/* harmony import */ var _modules_pageOnScroll__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/pageOnScroll */ "./src/js/modules/pageOnScroll.js");
...
if (typeof DOMTokenList !== "function" || !window.requestAnimationFrame || !('CSS' in window && 'supports' in CSS && CSS.supports('color', 'var(--body-color)'))) {
  var promise = _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_5___default().resolve();

  Promise.all(/*! import() | indigo-polyfills */[__webpack_require__.e("vendors-node_modules_babel_runtime-corejs3_core-js-stable_instance_entries_js-node_modules_ba-25b8cb"), __webpack_require__.e("indigo-polyfills")]).then(__webpack_require__.bind(__webpack_require__, /*! ./modules/polyfills */ "./src/js/modules/polyfills.js"));
}
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (fullPageElement && 'fullPageLicense' in window.indigo) {
    Promise.all(/*! import() | indigo-fullpage */[__webpack_require__.e("vendors-node_modules_babel_runtime-corejs3_core-js-stable_object_assign_js-node_modules_fullp-ce2191"), __webpack_require__.e("indigo-fullpage")]).then(__webpack_require__.bind(__webpack_require__, /*! ./modules/fullPageInit */ "./src/js/modules/fullPageInit.js"));
  }
});
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (stickSidebarElement) {
    Promise.all(/*! import() | indigo-sidebarStick */[__webpack_require__.e("vendors-node_modules_css-element-queries_index_js-node_modules_sticky-sidebar_src_sticky-sidebar_js"), __webpack_require__.e("indigo-sidebarStick")]).then(__webpack_require__.bind(__webpack_require__, /*! ./modules/sidebarStick */ "./src/js/modules/sidebarStick.js"));
  }
