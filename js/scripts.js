...
/******/ 		return __webpack_require__.p + "" + ({"vendors~css-vars-ponyfill":"vendors~css-vars-ponyfill"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
/* harmony import */ var _modules_fixedHeader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/fixedHeader */ "./src/js/modules/fixedHeader.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _onScrolling__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./onScrolling */ "./src/js/modules/onScrolling.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_1__);


document.addEventListener('DOMContentLoaded', function () {
  var fixedBrandingWrapper = document.querySelector('.has-fixed-header.header-overlay-content .site-header-wrapper');
  ...
  reCalculateHeader();
  window.addEventListener('resize', Object(lodash__WEBPACK_IMPORTED_MODULE_1__["debounce"])(reCalculateHeader, 100));
...
(function () {
  ...
  if (-1 === _babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_2___default()(_context = menu.className).call(_context, 'nav-menu')) {
  ...
  window.addEventListener('resize', lodash_debounce__WEBPACK_IMPORTED_MODULE_3___default()(function () {
    ...
    if (-1 !== _babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_2___default()(_context2 = body.className).call(_context2, 'toggled')) {
  ...
  button.onclick = function () {
    ...
    if (-1 !== _babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_2___default()(_context3 = body.className).call(_context3, 'toggled')) {
      body.className = body.className.replace(' menu-toggled', '');
      button.setAttribute('aria-expanded', 'false');
      menu.setAttribute('aria-expanded', 'false');
    } else {
  ...
  function toggleFocus() {
    ...
    while (-1 === _babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_2___default()(_context4 = self.className).call(_context4, 'nav-menu')) {
      var _context4;
      ...
      if ('li' === self.tagName.toLowerCase()) {
        ...
        if (-1 !== _babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_2___default()(_context5 = self.className).call(_context5, 'focus')) {
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_every__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/instance/every */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/every.js");
...
if (!requestFrame) {
  ...
  _babel_runtime_corejs3_core_js_stable_instance_every__WEBPACK_IMPORTED_MODULE_4___default()(_context = ['ms', 'moz', 'webkit', 'o']).call(_context, function (prefix) {
    requestFrame = window[prefix + 'RequestAnimationFrame'];
    cancelFrame = window[prefix + 'CancelAnimationFrame'] || window[prefix + 'CancelRequestAnimationFrame']; // Continue iterating only if requestFrame is still false
...
function handleScroll() {
  ...
  if (scrollY !== scrollYCached) {
    ...
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_3___default()(_context2 = callbackQueue.y).call(_context2, triggerCallback.y);
  ...
  if (scrollX !== scrollXCached) {
    ...
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_3___default()(_context3 = callbackQueue.x).call(_context3, triggerCallback.x);
  ...
  if (isScrollChanged) {
    ...
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_3___default()(_context4 = callbackQueue.any).call(_context4, triggerCallback.any);
...
function onScrolling(direction, callback) {
  ...
  enableScrollListener(); // Verify parameters
  ...
  if (typeof callback === 'function') {
    if (~_babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_2___default()(directionX).call(directionX, direction)) {
      callbackQueue.x.push(callback);
    } else if (~_babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_2___default()(directionAll).call(directionAll, direction)) {
...
onScrolling.remove = function (direction, fn) {
  ...
  fnIdx = _babel_runtime_corejs3_core_js_stable_instance_index_of__WEBPACK_IMPORTED_MODULE_2___default()(queue).call(queue, fn);

  if (fnIdx > -1) {
    _babel_runtime_corejs3_core_js_stable_instance_splice__WEBPACK_IMPORTED_MODULE_1___default()(queue).call(queue, fnIdx, 1);
...
/* harmony import */ var _onScrolling__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./onScrolling */ "./src/js/modules/onScrolling.js");
...
/*#__PURE__*/
function () {
  _babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_6___default()(pageOnScroll, [{
    key: "getCSSVar",
    ...
    value: function getCSSVar(property) {
      ...
      return _babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_4___default()(_context = getComputedStyle(document.documentElement).getPropertyValue(property)).call(_context);
    }
  }, {
    key: "getPosition",
  ...
  function pageOnScroll() {
    ...
    _babel_runtime_corejs3_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_5___default()(this, pageOnScroll);
    ...
    this.hexToRgb = function (hex) {
      ...
      return result ? {
        r: _babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_3___default()(result[1], 16),
        g: _babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_3___default()(result[2], 16),
        b: _babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_3___default()(result[3], 16)
      } : null;
    };
    ...
    if (this.isNavBarFixed) {//docEle.classList.add('has-fixed-header');
    }
    ...
    bodyScrolled();
    Object(_onScrolling__WEBPACK_IMPORTED_MODULE_7__["default"])(function () {
      bodyScrolled();
    });
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_values__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/instance/values */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/values.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_values__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_stable_instance_values__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_entries__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/instance/entries */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/entries.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_entries__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_stable_instance_entries__WEBPACK_IMPORTED_MODULE_17__);
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/promise */ "./node_modules/@babel/runtime-corejs3/core-js-stable/promise.js");
...
if (!('CSS' in window && CSS.supports('color', 'var(--body-color)'))) {
  var promise = _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_20___default.a.resolve();
...
if (!_babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_19___default()("")) String.prototype.trim = function () {
...
(function (window) {
  ...
  if (typeof DOMTokenList !== "function") (function (window) {
    ...
    function whenPropChanges() {
      ...
      if (!skipPropChange && (prop === "className" || prop === "classList" && !defineProperty)) {
        ...
        var tokens = _babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_19___default()(strval).call(strval).split(wsRE),
    ...
    function polyfillClassList(ele) {
      ...
      a: for (var toks = _babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_19___default()(_context = ele.className).call(_context).split(wsRE), cI = 0, _cLen2 = toks.length, _sub2 = 0; cI !== _cLen2; ++cI) {
        var _context;
      ...
      if (defineProperty) {
        defineProperty(ele, "classList", {
          ...
          set: function set(newVal) {
            ...
            var toks = _babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_19___default()(newVal).call(newVal).split(wsRE),
  ...
  (function (DOMTokenListProto, testClass) {
    ...
    if (!_babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_18___default()(DOMTokenListProto)) DOMTokenListProto.forEach = function (f) {
    ...
    if (!_babel_runtime_corejs3_core_js_stable_instance_entries__WEBPACK_IMPORTED_MODULE_17___default()(DOMTokenListProto)) DOMTokenListProto.entries = function () {
      var nextIndex = 0,
          that = this;
      return {
        next: function next() {
    ...
    if (!_babel_runtime_corejs3_core_js_stable_instance_values__WEBPACK_IMPORTED_MODULE_16___default()(DOMTokenListProto)) DOMTokenListProto.values = function () {
      var nextIndex = 0,
          that = this;
      return {
        next: function next() {
    ...
    if (!_babel_runtime_corejs3_core_js_stable_instance_keys__WEBPACK_IMPORTED_MODULE_15___default()(DOMTokenListProto)) DOMTokenListProto.keys = function () {
      var nextIndex = 0,
          that = this;
      return {
        next: function next() {
